...
@Component({
  selector: 'page-physical-properties-matter',
  templateUrl: 'physical-properties-matter.html',
})
export class PhysicalPropertiesMatterPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PhysicalPropertiesMatterPage');
  }
