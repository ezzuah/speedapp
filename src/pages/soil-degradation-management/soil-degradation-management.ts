...
@Component({
  selector: 'page-soil-degradation-management',
  templateUrl: 'soil-degradation-management.html',
})
export class SoilDegradationManagementPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SoilDegradationManagementPage');
  }
