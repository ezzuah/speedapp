...
@Component({
  selector: 'page-diversity-living-non-living',
  templateUrl: 'diversity-living-non-living.html',
})
export class DiversityLivingNonLivingPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DiversityLivingNonLivingPage');
  }
