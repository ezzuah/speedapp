...
@Component({
  selector: 'page-livestock-management',
  templateUrl: 'livestock-management.html',
})
export class LivestockManagementPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LivestockManagementPage');
  }
