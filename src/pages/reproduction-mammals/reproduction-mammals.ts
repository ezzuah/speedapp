...
@Component({
  selector: 'page-reproduction-mammals',
  templateUrl: 'reproduction-mammals.html',
})
export class ReproductionMammalsPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ReproductionMammalsPage');
  }
