...
@Component({
  selector: 'page-biological-processes-poultry',
  templateUrl: 'biological-processes-poultry.html',
})
export class BiologicalProcessesPoultryPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad BiologicalProcessesPoultryPage');
  }
