...
@Component({
  selector: 'page-management-practices-poultry',
  templateUrl: 'management-practices-poultry.html',
})
export class ManagementPracticesPoultryPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ManagementPracticesPoultryPage');
  }
