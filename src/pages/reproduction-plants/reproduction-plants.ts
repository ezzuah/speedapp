...
@Component({
  selector: 'page-reproduction-plants',
  templateUrl: 'reproduction-plants.html',
})
export class ReproductionPlantsPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ReproductionPlantsPage');
  }
