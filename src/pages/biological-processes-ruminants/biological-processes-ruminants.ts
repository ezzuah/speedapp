...
@Component({
  selector: 'page-biological-processes-ruminants',
  templateUrl: 'biological-processes-ruminants.html',
})
export class BiologicalProcessesRuminantsPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad BiologicalProcessesRuminantsPage');
  }
