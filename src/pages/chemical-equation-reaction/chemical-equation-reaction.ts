...
@Component({
  selector: 'page-chemical-equation-reaction',
  templateUrl: 'chemical-equation-reaction.html',
})
export class ChemicalEquationReactionPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ChemicalEquationReactionPage');
  }
