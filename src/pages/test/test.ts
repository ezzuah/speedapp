...
export class TestPage {
  ...
  constructor(public navCtrl: NavController, 
          ...
          this.test_year= localStorage.getItem('test_year');
  ...
  ngOnInit(){
    ...
    loader.present().then(()=>{
    this.http.get('http://speedapp.ididev.com/apps/scripts/test.php?year='+this.navparams.data.Quest_Year).map(res => res.json()).subscribe(data =>{
