...
@Component({
  selector: 'page-equillibrium-stability',
  templateUrl: 'equillibrium-stability.html',
})
export class EquillibriumStabilityPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EquillibriumStabilityPage');
  }
