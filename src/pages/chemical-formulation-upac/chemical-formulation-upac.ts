...
@Component({
  selector: 'page-chemical-formulation-upac',
  templateUrl: 'chemical-formulation-upac.html',
})
export class ChemicalFormulationUpacPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ChemicalFormulationUpacPage');
  }
