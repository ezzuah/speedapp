...
@Component({
  selector: 'page-indigenous-technology',
  templateUrl: 'indigenous-technology.html',
})
export class IndigenousTechnologyPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad IndigenousTechnologyPage');
  }
